/*   STEP 1   */
export const leagueID = "698644756355440640"; // your league ID
export const leagueName = "Ol Hoss Dynasty League"; // your league name
export const dues = 20; // (optional) used in template constitution page
export const dynasty = true; // true for dynasty leagues, false for redraft and keeper

/*   STEP 2   */
export const homepageText = `
   <p>Welcome to the official home page of the Ol Hoss Dynasty League! More info will be coming soon!.</p>
`;
...
export const managers = [
    {
      ...
      "location": "Murfreesboro, TN", // (optional)
      ...
      "favoritePlayer": 4737, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "RB", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Waking up in the morning and pissing excellence..",
      "tradingScale": 7, // 1 - 10
